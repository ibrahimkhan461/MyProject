package OHRMProject.OHRMProject;
...
public class LoginToOHRM {
	...
	public void loinToOHRM(String uname, String pass) {
	...
	public void afterMethod() throws IOException {
		...
		if (driver.getCurrentUrl().contains("dashboard")) {
			...
			TakesScreenshot screenshot = (TakesScreenshot) driver;
	         ...
	         File destinationFile = new File("D:\\Star Agile Training\\Java\\Java Tutorial\\OHRMProject\\ScreenShots\\ss.jpg");
